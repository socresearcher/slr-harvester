...
SLR Harvester is a desktop application for conducting structured, reproducible SLRs on **Scopus** within a persistent, dashboard‑based workflow environment.

This repository contains the source code and documentation. Start here, then jump into the docs below.
